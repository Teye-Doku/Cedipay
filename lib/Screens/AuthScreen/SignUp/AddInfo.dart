...
class _AddInfoState extends State<AddInfo> {
  ...
  void dob_change() async {
    ...
    print("$datePicked");
    String dateSubSstring = datePicked.toString().substring(0, 10);

    setState(() => {dob = dateSubSstring});
                ...
                child: Column(
                  children: <Widget>[
                    ...
                    Row(
                      children: <Widget>[
                        Text(
                          "Finish your final step to get access",
                          style: TextStyle(
                            color: Colors.white,
                            fontFamily: "Raleway",
                          ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          Text(
                            ...
                            style:
                                TextStyle(fontFamily: "Raleway", fontSize: 12),
                          )
                        ],
                      ),
                      Row(
